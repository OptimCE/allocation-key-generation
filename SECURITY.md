...
This service does not publish tagged releases yet. Security fixes are applied to
the `main` branch.
...
- The affected file(s), endpoint(s), or component (API, worker, algorithm)
...
This repository is the **allocation key generation** service. It is part of the
wider OptimCE platform, whose services live under the
[OptimCE organization](https://github.com/OptimCE). If a vulnerability affects a
different service, you can report it in that repository; if you are unsure,
