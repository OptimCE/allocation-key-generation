...
class _SubscriptionErrors:
    SUBSCRIPTION = Error(code=1000, key="ERRORS.SUBSCRIPTION.SUBSCRIPTION")
    UNSUBSCRIBED = Error(code=1001, key="ERRORS.SUBSCRIPTION.UNSUBSCRIBED")
    ALREADY_SUBSCRIBED = Error(code=1002, key="ERRORS.SUBSCRIPTION.ALREADY_SUBSCRIBED")
...
class _GenerationErrors:
    ...
    ALLOCATION_KEY_NOT_FOUND = Error(
        code=2003, key="ERRORS.GENERATION.ALLOCATION_KEY_NOT_FOUND"
    )
    ...
    GENERATION_NOT_FOUND = Error(
        code=2007, key="ERRORS.GENERATION.GENERATION_NOT_FOUND"
    )
    ...
    INVALID_ALGORITHM_INPUTS = Error(
        code=2012, key="ERRORS.GENERATION.INVALID_ALGORITHM_INPUTS"
    )
